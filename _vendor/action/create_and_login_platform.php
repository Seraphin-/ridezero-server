<?php
class create_and_login_platform {
    function runAction($params) {
        $newPlayer = false;
        if (($userData = UserModel::getDataByPlatform([$params['platform'], $params['id']])) === false) {
            $newPlayer = true;
            ...
            $playerId = UserModel::add([$params['platform'], $params['id'], $params['username'], 3, 3, NULL, 0, 0, 3, 0, 2, $randomString], true);
